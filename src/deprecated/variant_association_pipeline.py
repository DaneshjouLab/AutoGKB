...
from src.deprecated.all_variants import extract_all_variants
from src.deprecated.association_types import (
...
from src.deprecated.functional_annotation_extraction import (
